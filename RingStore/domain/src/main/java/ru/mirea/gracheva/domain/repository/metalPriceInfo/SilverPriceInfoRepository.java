...
public interface SilverPriceInfoRepository {
    void getSilverPriceInfo(MetalPriceCallback callback); ///метод запрашивает данные с сервера, данные в колбэке интерфейса для асинхронности, ничего не возвращает
